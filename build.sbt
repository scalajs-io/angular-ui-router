...
lazy val root = (project in file(".")).
  ...
  settings(
    ...
    description := "An angular-ui-router binding for Scala.js",
    version := apiVersion,
...
lazy val publishingSettings = Seq(
  ...
  pomExtra :=
    <url>https://github.com/scalajs-io/angular-ui-router</url>
      <licenses>
        <license>
      ...
      <scm>
        <connection>scm:git:github.com/scalajs-io/angular-ui-router.git</connection>
        <developerConnection>scm:git:git@github.com:scalajs-io/angular-ui-router.git</developerConnection>
        <url>github.com/scalajs-io/angular-ui-router.git</url>
      </scm>
      <developers>
        <developer>
          <id>ldaniels528</id>
